...
const dyteSpotlightGridCss = ":host{display:flex;height:100%;width:100%}main{flex:1 1 0%}aside{width:50%;max-width:var(--dyte-space-96, 384px)}:host([size='sm']),:host([size='md']){flex-direction:column}:host([size='sm']) aside,:host([size='md']) aside{height:50%;max-height:var(--dyte-space-96, 384px);width:100%;max-width:100%}:host([layout='column']){flex-direction:column}:host([layout='column']) main{flex:4}:host([layout='column']) aside{flex:2;max-width:100%;width:100%}";
...
const DyteSpotlightGrid = class {
  ...
  render() {
    ...
    return ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("main", { part: "main" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_cdc92050_js__WEBPACK_IMPORTED_MODULE_4__.R, { element: "dyte-simple-grid", defaults: defaults, props: {
        part: 'main-grid',
        participants: this.pinnedParticipants,
        aspectRatio: this.aspectRatio,
        gap: this.gap,
        size: 'md',
      } })), nonPinnedParticipants.length > 0 && ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("aside", { part: "aside" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_cdc92050_js__WEBPACK_IMPORTED_MODULE_4__.R, { element: "dyte-simple-grid", defaults: defaults, props: {
        part: 'aside-grid',
