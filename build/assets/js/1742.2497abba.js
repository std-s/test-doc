...
/* harmony import */ var _index_cdc92050_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(36391);
...
const DyteSidebar = class {
  constructor(hostRef) {
    ...
    this.close = () => {
      ...
      _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_5__.s.sidebar = this.tab;
    };
  }
  connectedCallback() {
    this.viewChanged(this.view);
    this.statesChanged(this.states);
    (0,_store_183b9cab_js__WEBPACK_IMPORTED_MODULE_5__.o)('sidebar', () => this.statesChanged());
  }
  disconnectedCallback() {
    this.keydownListener && document.removeEventListener('keydown', this.keydownListener);
  }
  statesChanged(s) {
    const states = s || _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_5__.s;
  ...
  viewSection(section) {
    ...
    _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_5__.s.activeSidebar = true;
    _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_5__.s.sidebar = this.tab;
  }
  render() {
    var _a;
    ...
    if (((_a = this.states) === null || _a === void 0 ? void 0 : _a.activeSidebar) === false || this.tab === 'none')
      return null;
    return ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, this.view === 'full-screen' && [
      (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("h3", { class: "title" }, this.t('About Call')),
      (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { id: "mobile-header" }, this.filterSections(this.enabledSections).map((section) => ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { key: section, variant: "ghost", class: { active: this.tab === section }, onClick: () => this.viewSection(section) }, this.t(section))))),
    ], (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: "ghost", kind: "icon", class: "close", onClick: this.close, "aria-label": this.t('Close') }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.dismiss })), this.view !== 'full-screen' && (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("h3", { class: "title" }, this.t(this.tab)), this.tab === 'chat' && (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_cdc92050_js__WEBPACK_IMPORTED_MODULE_3__.R, { element: "dyte-chat", defaults: defaults }), this.tab === 'polls' && (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_cdc92050_js__WEBPACK_IMPORTED_MODULE_3__.R, { element: "dyte-polls", defaults: defaults }), this.tab === 'participants' && (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_cdc92050_js__WEBPACK_IMPORTED_MODULE_3__.R, { element: "dyte-participants", defaults: defaults }), this.tab === 'plugins' && (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_cdc92050_js__WEBPACK_IMPORTED_MODULE_3__.R, { element: "dyte-plugins", defaults: defaults })));
  }
