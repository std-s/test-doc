...
/* harmony import */ var _string_703da00e_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(67553);
/* harmony import */ var _default_ui_config_98483031_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(92309);
/* harmony import */ var _index_cdc92050_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(36391);
...
/* harmony import */ var _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(43541);
...
const DyteSetupScreen = class {
  ...
  render() {
    ...
    const defaults = {
      ...
      config: this.config,
      states: this.states || _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_6__.s,
      size: this.size,
      iconPack: this.iconPack,
      t: this.t,
    };
    return ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "container" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_cdc92050_js__WEBPACK_IMPORTED_MODULE_2__.R, { element: "dyte-participant-tile", defaults: defaults, props: { participant: (_b = this.meeting) === null || _b === void 0 ? void 0 : _b.self, size: 'md' }, childProps: { participant: (_c = this.meeting) === null || _c === void 0 ? void 0 : _c.self, size: 'md' }, deepProps: true }), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "metadata" }, this.displayName.trim() === '' ? ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "name" }, this.t('setup_screen.join_in_as'))) : ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "label" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, this.t('setup_screen.joining_as')), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "name" }, (0,_string_703da00e_js__WEBPACK_IMPORTED_MODULE_8__.s)(this.displayName, 20)))), this.canEditName && ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { placeholder: this.t('setup_screen.your_name'), value: this.displayName, autoFocus: true, onInput: (e) => {
        this.displayName = e.target.value;
      }, onKeyDown: (e) => {
        if (e.key === 'Enter') {
          this.join();
        }
      } })), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { size: "lg", kind: "wide", onClick: this.join, disabled: disabled }, this.isJoining ? (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-spinner", null) : 'Join')))));
  }
