...
/* harmony import */ var _index_29271762_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(17578);
...
const DyteBreakoutRoomManager = class {
  constructor(hostRef) {
    ...
    this.onParticipantDelete = (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "participantDelete", 7);
    this.onParticipantsAdd = (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "participantsAdd", 7);
    this.deleteRoom = (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "delete", 7);
    this.updateRoom = (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "update", 7);
    /** Icon pack */
  ...
  render() {
    var _a, _b, _c, _d, _e;
    return ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: this.assigningParticipants ? 'assign-mode' : 'selector-mode' }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "header" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { placeholder: "Room Name", disabled: !this.room.isTitleEditorOpen, value: (_b = (_a = this.room) === null || _a === void 0 ? void 0 : _a.title) !== null && _b !== void 0 ? _b : `Room ${this.room.id + 1}`, onChange: (e) => {
        this.meeting.connectedMeetings.stateManager.renameConnectedMeeting(this.room.id, e.target.value);
      } }), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-tooltip", { label: this.t('Edit Room Name') }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: !this.room.isTitleEditorOpen ? this.iconPack.edit : this.iconPack.checkmark, class: "show-on-hover", onClick: () => {
      ...
      } })), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", null, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-tooltip", { label: this.t('Delete Room'), class: "danger" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.delete, class: "show-on-hover", onClick: () => {
        this.meeting.connectedMeetings.stateManager.deleteConnectedMeetings([
          this.room.id,
        ]);
      } })), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.participants }), (_e = (_d = (_c = this.room) === null || _c === void 0 ? void 0 : _c.participants) === null || _d === void 0 ? void 0 : _d.length) !== null && _e !== void 0 ? _e : '0')), this.room.participants.length > 0 && ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "participant-list", onClick: () => {
        this.onParticipantsAdd.emit();
      } }, this.room.participants.map((item) => ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "participant-item" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-participant", { role: "listitem", key: item.id, meeting: this.meeting, participant: this.getPeer(item.clientSpecificId), view: "breakout-room-manager", onParticipantDelete: () => {
        this.meeting.connectedMeetings.stateManager.unassignParticipants([
          item.clientSpecificId,
        ]);
      } })))))), (this.assigningParticipants || this.room.participants.length < 1) && ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "message-container" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", { onClick: () => {
        this.onParticipantsAdd.emit();
...
const DyteCounter = class {
  constructor(hostRef) {
    (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.r)(this, hostRef);
    this.onChange = (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "valueChange", 7);
    /** Input */
    this.input = '1';
    /** Icon pack */
    this.iconPack = _default_icon_pack_fb869041_js__WEBPACK_IMPORTED_MODULE_2__.d;
  ...
  render() {
    return ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { kind: "icon", variant: "ghost", onClick: () => this.decrement() }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.subtract })), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { type: "number", value: this.input, onInput: (e) => {
        this.input = e.target.value;
      } }), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { kind: "icon", variant: "ghost", onClick: () => this.increment() }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.add }))));
  }
...
const DyteParticipants = class {
  constructor(hostRef) {
    ...
    this.peerPresentingUpdateListener = (peer) => {
      this.updatePeer(peer !== null && peer !== void 0 ? peer : this.meeting.self);
  ...
  disconnectedCallback() {
    ...
    this.peerRequestToJoinStateListener &&
      participants.joined.removeListener('peerRequestToJoinStage', this.peerRequestToJoinStateListener);
  ...
  getParticipants() {
    ...
    return list.filter((p) => { var _a; return ((_a = p.name) !== null && _a !== void 0 ? _a : p.id).toLowerCase().includes(search.toLowerCase()); });
  }
  getWebinarViewers() {
    const search = this.search.trim();
    const list = this.participants.filter((p) => p.webinarStageStatus !== 'ON_STAGE');
    if (search === '') {
      return list;
    }
    return list.filter((p) => { var _a; return ((_a = p.name) !== null && _a !== void 0 ? _a : p.id).toLowerCase().includes(search.toLowerCase()); });
  }
  renderWebinarViewers() {
    if (this.meeting && this.meeting.meta.viewType !== 'WEBINAR')
      return null;
    const viewers = this.getWebinarViewers();
    return ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "list" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "heading-count", part: "heading-count" }, this.t('Viewers'), " (", viewers.length, ")"), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("ul", { class: "participants", part: "participants" }, viewers.map((participant) => ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-participant", { role: "listitem", key: participant.id, meeting: this.meeting, participant: participant, view: this.view }))), viewers.length === 0 && ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "empty-message", part: "empty-message" }, this.t('It looks like nobody else is here.'))))));
  }
  renderSidebarView(participants) {
    ...
    const sections = [];
    if (showPresentRequest) {
      sections.push((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "stage-requested-participants" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "heading-count", part: "waitlisted-heading-count" }, this.t('stage_request.header_title'), " (", this.stageRequestedParticipants.length, ")"), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("ul", { class: "participants", part: "waitlisted-participants" }, this.stageRequestedParticipants.map((participant) => ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("li", { class: "waiting-participant", key: participant.id }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "participant-details" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-avatar", { participant: participant, size: "sm" }), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", { class: "name", title: participant.name }, participant.name)), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "waitlist-controls" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-tooltip", { label: this.t('stage_request.deny_request'), variant: "secondary" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: "secondary", kind: "icon", onClick: () => this.rejectStageRequest(participant.id) }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { class: "deny", icon: this.iconPack.dismiss }))), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-tooltip", { label: this.t('stage_request.accept_request'), variant: "secondary" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: "secondary", kind: "icon", onClick: () => this.acceptStageRequest(participant.id) }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { class: "accept", icon: this.iconPack.checkmark })))))))), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "bulk-actions" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { class: "accept-all-button", variant: "secondary", onClick: this.acceptAllStageRequest }, this.t('stage_request.accept_all')), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { class: "deny-all-button", variant: "danger", onClick: this.denyAllStageRequest }, this.t('stage_request.deny_all')))));
    }
    if (showWaitlist) {
      sections.push((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "waiting-participants" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "heading-count", part: "waitlisted-heading-count" }, this.t('waitlist.header_title'), " (", this.waitlistedParticipants.length, ")"), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("ul", { class: "participants", part: "waitlisted-participants" }, this.waitlistedParticipants.map((participant) => ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("li", { class: "waiting-participant", key: participant.id }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "participant-details" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-avatar", { participant: participant, size: "sm" }), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", { class: "name", title: participant.name }, participant.name)), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "waitlist-controls" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-tooltip", { label: this.t('waitlist.deny_request'), variant: "secondary" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: "secondary", kind: "icon", onClick: () => this.rejectWaitingRoomRequest(participant.id) }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { class: "deny", icon: this.iconPack.dismiss }))), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-tooltip", { label: this.t('waitlist.accept_request'), variant: "secondary" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: "secondary", kind: "icon", onClick: () => this.acceptWaitingRoomRequest(participant.id) }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { class: "accept", icon: this.iconPack.checkmark })))))))), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { class: "accept-all-button", variant: "secondary", kind: "wide", onClick: this.acceptAllWaitingRoomRequests }, this.t('waitlist.accept_all'))));
    }
    sections.push((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "heading-count", part: "heading-count" }, this.t('In Call'), " (", participants.length, ")"));
    return sections;
  }
  render() {
    let participants = this.getParticipants();
    return ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "search", part: "search" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.search, part: "search-icon" }), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { type: "search", autocomplete: "off", placeholder: "Search", onInput: this.onSearchInput, part: "search-input" })), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "ctr scrollbar", part: "container" }, this.renderSidebarView(participants), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("ul", { class: "participants", part: "participants" }, participants.map((participant) => ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-participant", { role: "listitem", key: participant.id, meeting: this.meeting, participant: participant, view: this.view }))), participants.length === 0 && ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "empty-message", part: "empty-message" }, this.search.length > 0
      ? this.t('Participant with specified name not found.')
      : this.t('It looks like nobody is here.')))), this.renderWebinarViewers())));
  }
  static get watchers() { return {
