...
const DytePollsToggle = class {
  ...
  togglePollsTab() {
    ...
    _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_3__.s.activeSidebar = this.pollsActive;
    _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_3__.s.sidebar = this.pollsActive ? 'polls' : 'none';
  }
  render() {
    var _a;
    ...
    if (!((_a = this.meeting.self.config) === null || _a === void 0 ? void 0 : _a.controlBar.elements.polls))
      return;
    return ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: text }, this.unreadPollsCount !== 0 && !this.pollsActive && ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "unread-count", part: "unread-count" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", null, this.unreadPollsCount <= 100 ? this.unreadPollsCount : '99+'))), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, class: { active: this.pollsActive }, onClick: () => this.togglePollsTab(), icon: this.iconPack.poll, label: text, variant: this.variant })));
  }
