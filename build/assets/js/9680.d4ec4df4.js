...
const DyteBreakoutRoomsManager = class {
  constructor(hostRef) {
    ...
    this.enableConfirmationModal = () => {
      ...
      _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_3__.s.activeBreakoutRoomsManager = { active: false, data: undefined };
      _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_3__.s.activeConfirmationModal = activeConfirmationModal;
    };
    ...
    this.updateBreakoutRooms = async () => {
      ...
      _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_3__.s.activeBreakoutRoomsManager = {
        active: !((_b = _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_3__.s.activeBreakoutRoomsManager) === null || _b === void 0 ? void 0 : _b.active),
      };
  ...
  close() {
    ...
    _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_3__.s.activeBreakoutRoomsManager = { active: false };
  }
  updateState(state) {
    this.unassignedParticipants = [];
    this.selectedParticipants = [];
  ...
  render() {
    return ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, this.roomConfig.state === 'room-config' ? ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "room-config" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("header", null, this.t('Create Breakout Rooms')), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "create-room" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, "Number of Rooms"), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-counter", { value: this.roomConfig.rooms, onValueChange: (val) => {
        this.roomConfig = Object.assign(Object.assign({}, this.roomConfig), { rooms: Math.max(+val.detail, 1) });
      } }), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("br", null), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, "Default Permissions"), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("label", null, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { type: "checkbox", disabled: true, checked: false }), "\u2002Allow switching between rooms"), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("label", null, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { type: "checkbox", disabled: true, checked: false }), "\u2002Can go back to main room")), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("footer", null, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { onClick: () => this.close(), kind: "button", size: "lg", variant: "ghost", title: this.t('Cancel') }, "Cancel"), "\u2002", (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { kind: "button", size: "lg", title: this.t('Create'), onClick: () => this.updateState('participants-config') }, "Create")))) : ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "participant-config" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("aside", { part: "menu" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("header", null, this.t('Assign Participants')), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-participants", { meeting: this.meeting, view: "breakout-rooms-manager", unassignedParticipants: this.unassignedParticipants, onSelectedParticipantUpdate: this.updateSelectedParticipants, mode: this.roomConfig.mode }), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "assign-participants" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { disabled: this.roomConfig.mode === 'edit', kind: "button", variant: "ghost", size: "md", onClick: () => this.meeting.connectedMeetings.stateManager.assignParticipantsRandomly() }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "row-button" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.shuffle }), "Assign Randomly")))), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "assign-rooms" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: {
        back: true,
        disabled: this.roomConfig.mode === 'edit',
      }, onClick: () => this.switchManagerState() }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.chevron_left }), "Back"), this.assigningParticipants ? ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", { class: "row assign-text" }, "Select a room to assign ", this.selectedParticipants.length, " participant/s.")) : ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "row" }, "Rooms (", this.meeting.connectedMeetings.stateManager.getConnectedMeetings().length, ")", (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "cta-buttons" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { kind: "button", variant: "ghost" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { onClick: this.addNewRoom }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.add }), "Add Room")), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { kind: "button", variant: "ghost", disabled: this.unassignedParticipants.length == null, onClick: this.onUnassignAll }, "Unassign All")))), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "rooms", ref: (el) => (this.selectorRef = el) }, this.connectedRooms.map((room) => {
      return ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-breakout-room-manager", { key: room['id'], onParticipantsAdd: () => this.addParticipantsToRoom(room['id']), assigningParticipants: this.assigningParticipants, meeting: this.meeting, onDelete: () => this.onRoomDelete(room['id']), mode: this.roomConfig.mode, onParticipantDelete: (id) => this.onParticipantDelete(id.detail), states: this.states, room: Object.assign({}, room) }));
    })), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "start-breakout" }, this.roomConfig.optionsToggle && ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "more-options" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", { onClick: this.reset }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.back }), this.t('Reset')))), this.roomConfig.mode !== 'edit' && ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { size: "md" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", null, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { onClick: this.enableConfirmationModal }, "Start Breakout \u2002 | \u2002"), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { onClick: () => {
        ...
        : this.iconPack.chevron_up })))), this.roomConfig.mode === 'edit' && ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { size: "md", onClick: this.updateBreakoutRooms, disabled: this.roomConfig.applyingChanges }, "Apply Changes"))))))));
  }
