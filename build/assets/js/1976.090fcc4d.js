...
const DyteWebinarStageToggle = class {
  ...
  connectedCallback() {
    ...
    (0,_store_183b9cab_js__WEBPACK_IMPORTED_MODULE_3__.o)('activeJoinStage', (activeJoinStage) => this.activeJoinStageChanged(activeJoinStage));
  }
  ...
  render() {
    ...
    return ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: label }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-tooltip", { placement: "top", kind: "block", label: tooltipLabel, delay: 600, part: "tooltip" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, variant: this.variant, label: label, icon: icon, class: classList, onClick: this.stageCallback, disabled: disabled, showWarning: false }))));
  }
