...
/* harmony export */   "dyte_breakout_room_tile": () => (/* binding */ DyteBreakoutRoomTile)
/* harmony export */ });
...
const DyteBreakoutRoomTile = class {
  constructor(hostRef) {
  ...
  render() {
    var _a, _b, _c;
    return ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.H, { class: { current: this.isCurrent } }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "header" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, this.isParent && (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.web }), (_a = this.room) === null || _a === void 0 ? void 0 :
      _a.title), this.isCurrent && (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", { class: "current-room-text" }, "Current Room")), ((_b = this.room) === null || _b === void 0 ? void 0 : _b.participants.length) > 0 ? ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "participant-list" }, (_c = this.room) === null || _c === void 0 ? void 0 : _c.participants.map((p) => {
      return ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-participant", { view: "breakout-room-tile", participant: p }));
    }))) : ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", { class: "message" }, "Nobody here yet.")), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "footer" }, this.canSwitch() && (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { onClick: this.switchMeeting }, "Switch"))));
  }
  static get watchers() { return {
    "meeting": ["meetingChanged"]
  }; }
};
DyteBreakoutRoomTile.style = dyteBreakoutRoomTileCss;
