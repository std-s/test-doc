...
const DyteConfirmationModal = class {
  constructor(hostRef) {
    ...
    this.close = () => {
      ...
      _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_3__.s.activeConfirmationModal = { active: false };
      this.states.activeConfirmationModal.onClose(this.stateUpdate, _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_3__.s, this.meeting);
    };
    this.onConfirmation = async () => {
      this.stateUpdate.emit({ activeConfirmationModal: { active: false } });
      _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_3__.s.activeConfirmationModal = { active: false };
      this.states.activeConfirmationModal.onClick(this.stateUpdate, _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_3__.s, this.meeting);
    };
  }
  connectedCallback() {
  ...
  render() {
    ...
    return ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "leave-modal" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "header" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("h2", { class: "title" }, this.t('Are you sure?'))), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", { class: "message" }, this.t((_a = state === null || state === void 0 ? void 0 : state.content) !== null && _a !== void 0 ? _a : 'This is a confirmation modal')), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "content" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "leave-meeting" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: "secondary", title: this.t((_b = state === null || state === void 0 ? void 0 : state.cancelText) !== null && _b !== void 0 ? _b : 'Cancel'), onClick: this.close }, this.t((_c = state === null || state === void 0 ? void 0 : state.cancelText) !== null && _c !== void 0 ? _c : 'Cancel')), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { onClick: () => this.onConfirmation(), variant: (_e = (_d = this.states.activeConfirmationModal) === null || _d === void 0 ? void 0 : _d.variant) !== null && _e !== void 0 ? _e : 'danger', title: this.t((_f = state === null || state === void 0 ? void 0 : state.ctaText) !== null && _f !== void 0 ? _f : 'Yes') }, this.t((_g = state === null || state === void 0 ? void 0 : state.ctaText) !== null && _g !== void 0 ? _g : 'Yes')))))));
  }
};
