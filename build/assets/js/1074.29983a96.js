...
const DytePolls = class {
  constructor(hostRef) {
    ...
    this.onVote = (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "dyteVotePoll", 7);
    /** Icon pack */
  ...
  render() {
    return ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "ctr" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", { class: "poll-title" }, this.t('Poll by'), " ", (0,_string_703da00e_js__WEBPACK_IMPORTED_MODULE_4__.s)((0,_string_703da00e_js__WEBPACK_IMPORTED_MODULE_4__.f)(this.poll.createdBy), 20)), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "poll" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", { class: "poll-question" }, this.poll.question), this.poll.options.map((item, index) => ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: {
        active: item.votes.some((x) => x.id === this.self),
        'poll-option': true,
      } }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "poll-option-header" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("label", null, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { type: "checkbox", checked: item.votes.some((x) => x.id === this.self), onClick: (e) => this.vote(e, index) }), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, item.text, " (", item.count, ")"))), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "votes" }, item.votes.map((vote) => {
      if (this.poll.anonymous && this.self !== this.poll.createdByUserId)
        return;
      return ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-tooltip", { label: vote.name }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "vote" }, (0,_utils_513ded39_js__WEBPACK_IMPORTED_MODULE_5__.g)(vote.name))));
    })))))))));
  }
};
...
const DytePoll = class {
  constructor(hostRef) {
    (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.r)(this, hostRef);
    this.onCreate = (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "dyteCreatePoll", 7);
    /** Icon pack */
    this.iconPack = _default_icon_pack_fb869041_js__WEBPACK_IMPORTED_MODULE_1__.d;
    /** Language */
    this.t = (0,_index_6a31a13a_js__WEBPACK_IMPORTED_MODULE_2__.u)();
  ...
  render() {
    return ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "create-poll" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, this.t('Poll Question')), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("textarea", { onInput: () => {
        if (this.error && this.error.code === 0)
          this.error = undefined;
      }, ref: (e) => (this.question = e), placeholder: this.t('What is your poll for?') }), this.options.map((item, index) => ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "option" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { placeholder: this.t('Enter an option'), value: item, onInput: (event) => this.updateOption(event, index) }), index > 1 && ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { kind: "icon", class: "auto remove-option", variant: "secondary", onClick: () => this.removeOption(index) }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.subtract })))))), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { class: "add-option", variant: "secondary", onClick: () => this.addOption() }, this.t('Add an option')), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("label", null, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { id: "anonymous", type: "checkbox", onChange: (e) => (this.anonymous = e.target.checked) }), this.t('Anonymous')), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("label", null, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { id: "hideVotes", type: "checkbox", disabled: this.anonymous, checked: this.anonymous ? true : this.hideVotes, onChange: (e) => (this.hideVotes = e.target.checked) }), this.t('Hide results before voting')), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { kind: "wide", onClick: () => this.handleSubmit() }, this.t('Create Poll')), this.error && (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { class: "error-text" }, this.error.message))));
  }
};
