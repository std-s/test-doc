...
const DyteMicToggle = class {
  constructor(hostRef) {
    ...
    this.toggleMic = () => {
      ...
      if (this.hasPermissionError()) {
        ...
        _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_3__.s.activePermissionsMessage = true;
        return false;
      }
  ...
  render() {
    ...
    return ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: label }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-tooltip", { kind: "block", label: tooltipLabel, part: "tooltip" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { part: "controlbar-button", icon: icon, label: label, size: this.size, iconPack: this.iconPack, variant: this.variant, class: classList, onClick: this.toggleMic, showWarning: showWarning, disabled: showWarning }))));
  }
