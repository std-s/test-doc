...
/* harmony export */   "dyte_breakout_room_grid": () => (/* binding */ DyteBreakoutRoomGrid)
/* harmony export */ });
...
const DyteBreakoutRoomGrid = class {
  constructor(hostRef) {
    ...
    this.editBreakout = () => {
      ...
      _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_4__.s.activeBreakoutRoomsManager = {
        active: !((_c = _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_4__.s.activeBreakoutRoomsManager) === null || _c === void 0 ? void 0 : _c.active),
      };
    ...
    this.endBreakout = async () => {
      ...
      _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_4__.s.activeOverlayModal = activeOverlayModal;
      ...
      _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_4__.s.activeBreakoutRooms = false;
      _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_4__.s.activeBreakoutRoomGrid = false;
      _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_4__.s.activeOverlayModal = { active: false };
    };
  ...
  render() {
    ...
    return ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "header" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, "Breakout Rooms Overview"), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "buttons" }, permissions.canAlterConnectedMeetings && ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: "ghost" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "button-row", onClick: this.editBreakout }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.edit }), "Edit Breakout"))), permissions.canAlterConnectedMeetings && ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { variant: "danger", onClick: this.endBreakout }, "End Breakout")), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { kind: "icon", variant: "ghost", onClick: this.closeBreakoutGrid }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.dismiss })))), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "rooms-grid" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", null, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-breakout-room-tile", { meeting: this.meeting, states: this.states, room: this.meeting.connectedMeetings.parentMeeting, isParent: true, isCurrent: ((_d = this.meeting.connectedMeetings.parentMeeting) === null || _d === void 0 ? void 0 : _d.id) === this.meeting.meta.roomName }), activeMeeting && ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-breakout-room-tile", { meeting: this.meeting, states: this.states, room: activeMeeting, isCurrent: true })), (_f = (_e = this.meeting.connectedMeetings) === null || _e === void 0 ? void 0 : _e.list) === null || _f === void 0 ? void 0 :
      _f.map((room) => {
        if (room.status !== 'ACTIVE' || (activeMeeting === null || activeMeeting === void 0 ? void 0 : activeMeeting.id) === room.id)
          return;
        return ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-breakout-room-tile", { meeting: this.meeting, states: this.states, room: room, isParent: false, isCurrent: (room === null || room === void 0 ? void 0 : room.id) === this.meeting.meta.roomName }));
      })))));
  }
};
DyteBreakoutRoomGrid.style = dyteBreakoutRoomGridCss;
