...
const DyteChatToggle = class {
  constructor(hostRef) {
    ...
    this.toggleChat = () => {
      ...
      _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_3__.s.activeSidebar = this.chatActive;
      _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_3__.s.sidebar = this.chatActive ? 'chat' : 'none';
  ...
  render() {
    ...
    if (config && !config.controlBar.elements.chat)
      return;
    return ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: this.t('chat') }, this.unreadMessageCount !== 0 && !this.chatActive && ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "unread-count", part: "unread-count" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", null, this.unreadMessageCount <= 100 ? this.unreadMessageCount : '99+'))), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, class: { active: this.chatActive }, onClick: this.toggleChat, icon: this.iconPack.chat, label: this.t('chat'), variant: this.variant })));
  }
