...
/* harmony import */ var _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(43541);
...
const DytePipToggle = class {
  ...
  statesChanged(s) {
    const states = s || _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_7__.s;
  ...
  meetingChanged(meeting) {
    ...
    this.pipEnabled = this.states.activePipMode;
  }
  togglePip() {
    const { activePipMode } = this.states;
    // Not active, activate
    if (activePipMode !== true) {
      _pipStore_094537d3_js__WEBPACK_IMPORTED_MODULE_6__.s.updateMediaSession(_pipStore_094537d3_js__WEBPACK_IMPORTED_MODULE_6__.P.CAMERA, this.meeting.self.videoEnabled);
      _pipStore_094537d3_js__WEBPACK_IMPORTED_MODULE_6__.s.updateMediaSession(_pipStore_094537d3_js__WEBPACK_IMPORTED_MODULE_6__.P.MIC, this.meeting.self.audioEnabled);
      _pipStore_094537d3_js__WEBPACK_IMPORTED_MODULE_6__.s.enable();
      this.stateUpdate.emit({ activePipMode: true });
    }
    else {
      _pipStore_094537d3_js__WEBPACK_IMPORTED_MODULE_6__.s.disable();
  ...
  render() {
    if (!this.pipSupported)
      return;
    return ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.H, { tabIndex: 0, role: "log", "aria-label": `Picture-in-Picture mode` }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, onClick: () => this.togglePip(), icon: this.pipEnabled ? this.iconPack.pip_on : this.iconPack.pip_off, label: this.pipEnabled ? this.t('pip_off') : this.t('pip_on'), variant: this.variant })));
  }
