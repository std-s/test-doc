...
const DytePluginMain = class {
    ...
    if (meeting != null) {
      ...
      if (permissions.plugins.config !== undefined) {
        ...
        const whitelistedControl = (((_a = permissions.plugins.config[normalizedPluginId]) === null || _a === void 0 ? void 0 : _a.defaultAccess) || 'blacklist') ===
          'whitelist';
        if (this.plugin.enabledBy === meeting.self.userId || permissions.plugins.canEditAcl) {
          this.canControl = true;
        }
  ...
  pluginChanged(plugin) {
    ...
    if (plugin != null) {
      ...
      plugin.on('toggleViewMode', this.toggleViewModeListener);
    }
  }
  ...
  render() {
    if (this.plugin == null)
      return null;
    return ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("header", { part: "header" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", null, this.plugin.name), this.canClosePlugin && ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", null, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { kind: "icon", onClick: () => this.plugin.deactivate(), part: "button" }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.dismiss }))))), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: 'iframe-container' }, !this.canControl && (this.viewModeEnabled ? (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "block-inputs" }) : null), (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("iframe", { ref: (el) => (this.iframeEl = el), part: "iframe" }))));
  }
