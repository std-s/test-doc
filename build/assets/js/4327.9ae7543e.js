...
const DytePluginsToggle = class {
  ...
  togglePlugins() {
    ...
    _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_3__.s.activeSidebar = this.pluginsActive;
    _store_183b9cab_js__WEBPACK_IMPORTED_MODULE_3__.s.sidebar = this.pluginsActive ? 'plugins' : 'none';
  }
  render() {
    var _a, _b, _c;
    ...
    if (config && !((_c = (_b = config.controlBar) === null || _b === void 0 ? void 0 : _b.elements) === null || _c === void 0 ? void 0 : _c.plugins))
      return;
    return ((0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: text }, (0,_index_60449c9e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { part: "controlbar-button", size: this.size, iconPack: this.iconPack, class: { active: this.pluginsActive }, onClick: () => this.togglePlugins(), icon: this.iconPack.rocket, label: text, variant: this.variant })));
  }
